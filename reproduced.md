...
然後開一場有文字雲的活動，看投影／觀眾結果頁：新詞會交錯進場，詞會慢慢漂浮，同一詞被重複送出時會短暫放大。只有一個答案時，該詞大約占文字雲高度的三分之一；詞變多後字級會縮小，高頻詞仍明顯較大。觀眾同一題最多可送 3 則，送出後輸入框會清空以便再送。講者在投影頁或手機遙控點選詞可釘住，釘住的詞會加金框且不再隨新答案移動。投影頁標題會縮小，文字雲畫布約占畫面高度三分之二。
